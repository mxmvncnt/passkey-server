...
var RPDisplayName = thisOrThat(os.Getenv("WEBAUTHN_DISPLAYNAME"), "Chaquevoix")
var RPID = thisOrThat(os.Getenv("WEBAUTHN_RPID"), "localhost")
var RPOrigins = strings.Split(thisOrThat(os.Getenv("WEBAUTHN_ORIGINS"), "localhost"), ",")
